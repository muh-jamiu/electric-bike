...
export default function Rentals() {
    document.title = 'Bike Rentals | Dashboard';
                    ...
                    {!loading &&
                        <div className="main_">
                            <div className="d-flex sec_head justify-content-between">
                                <h4 className="fw-bold mt-3">Bike Rentals</h4>
                            </div>
                            ...
                            <div className="text-center mt-5 pt-5">
                                ...
                                <p className="text-muted ft">There are no available rentals at the moment.</p>
                            </div>
